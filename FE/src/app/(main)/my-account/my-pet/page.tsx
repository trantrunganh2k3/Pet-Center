...
const MyPet = () => {
    ...
    const filteredPets = petsPerCustomer
        .filter(pet => 
    ...
    const uniqueSpecies = Array.from(new Set(petsPerCustomer.map(pet => pet.species)));
                    ...
                    {filteredPets.length > 0 && (
                        <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
                            <div className="text-sm text-gray-700">
                                ...
                                {searchTerm && <span> (đã lọc từ {petsPerCustomer.length} thú cưng)</span>}
                            </div>
